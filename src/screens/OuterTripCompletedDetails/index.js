...
const TripCompletedScreen = ({ navigation }) => { // Add navigation prop
  return (
    <View style={styles.container}>
      ...
      <View style={styles.fareContainer}>
        ...
        <Text style={styles.fareLabel}>Ride Fare for outer Area Trips</Text>
      </View>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('OuterTripDashboard')} // Corrected onPress prop
      >
